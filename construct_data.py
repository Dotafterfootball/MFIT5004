...
x_train, x_test, y_train, y_test, z_train, z_test = train_test_split(pad_headlines, norm_price, price_his, test_size = 0.15, random_state = 2, shuffle=True)
...
model = build_model()
model.fit([x_train,x_train, z_train], y_train, batch_size=128, epochs=10, validation_split=0.15, verbose=True, shuffle=True)
#model.load_weights('./question_pairs_weights_deeper={}_wider={}_lr={}_dropout={}.h5'.format(
#                    deeper,wider,learning_rate,dropout))
predictions = model.predict([x_test,x_test,z_test], verbose = True)
